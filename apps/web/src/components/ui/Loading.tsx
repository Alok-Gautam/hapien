...
export function LoadingCard() {
  return (
    <div className="bg-stone-800 rounded-2xl p-5 animate-pulse">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 bg-stone-700 rounded-full" />
        <div className="flex-1">
          <div className="h-4 bg-stone-700 rounded w-1/3 mb-2" />
...
export function LoadingHangoutCard() {
  return (
    <div className="bg-stone-800 rounded-2xl overflow-hidden animate-pulse">
      <div className="h-32 bg-stone-700" />
      <div className="p-4">
        <div className="h-5 bg-stone-700 rounded w-3/4 mb-2" />
        <div className="h-4 bg-stone-700 rounded w-1/2 mb-3" />
        <div className="flex items-center gap-2">
          <div className="h-3 bg-stone-700 rounded w-20" />
